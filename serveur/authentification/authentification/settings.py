...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        'activation': '3/min',   # tentatives d'activation
        'login': '5/min',       # tentatives de connexion
    },

}

# (Optionnel) Informations sur ton API
SPECTACULAR_SETTINGS = {
    'TITLE': 'API Mon Application',
    'DESCRIPTION': 'Documentation automatique des endpoints de mon projet',
    'VERSION': '1.0.0',
...
# Optionnel mais recommandé pour la mise en cache avec WhiteNoise
